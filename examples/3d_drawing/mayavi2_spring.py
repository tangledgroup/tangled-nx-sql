...
This example requires mayavi (OpenGL-based 3D visualization), which has
...
"""
print("SKIPPED: This example requires 'mayavi' — a GUI-based 3D visualization")
print("toolkit with no headless or CLI mode. No non-interactive alternative exists.")
